...
namespace ArcaSolutions\ModStoresBundle\Plugins\TailoredMapListing\Command;
...
class EdirectoryModstoresInstallCommand extends AbstractEdirectoryModstoresInstallCommand
{
    ...
    public function afterCommandWorkflow()
    {
        ...
        $this->appendToData('afterCommand', [
            'fixture:domain' => [
                'fixtures' => [
                    'src/ArcaSolutions/ModStoresBundle/Plugins/TailoredMapListing/DataFixtures/ORM/Common',
                ],
            ],
        ]);
    }
