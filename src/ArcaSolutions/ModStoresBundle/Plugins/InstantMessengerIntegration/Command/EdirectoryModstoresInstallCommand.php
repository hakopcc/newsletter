...
namespace ArcaSolutions\ModStoresBundle\Plugins\InstantMessengerIntegration\Command;
...
class EdirectoryModstoresInstallCommand extends AbstractEdirectoryModstoresInstallCommand
{
    ...
    public function afterCommandWorkflow()
    {
        ...
        $this->appendToData('afterCommand', [
            'fixture:domain' => [
                'fixtures' => [
                    'src/ArcaSolutions/ModStoresBundle/Plugins/InstantMessengerIntegration/DataFixtures/ORM/Common',
                ],
            ],
        ]);
    }
