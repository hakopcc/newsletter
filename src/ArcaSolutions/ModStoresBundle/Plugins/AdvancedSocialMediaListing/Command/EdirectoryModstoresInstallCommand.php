...
namespace ArcaSolutions\ModStoresBundle\Plugins\AdvancedSocialMediaListing\Command;
...
class EdirectoryModstoresInstallCommand extends AbstractEdirectoryModstoresInstallCommand
{
    ...
    public function afterCommandWorkflow()
    {
        ...
        $this->appendToData('afterCommand', [
            'fixture:domain' => [
                'fixtures' => [
                    'src/ArcaSolutions/ModStoresBundle/Plugins/AdvancedSocialMediaListing/DataFixtures/ORM/Common',
                ],
            ],
        ]);
    }
