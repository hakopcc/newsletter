...
namespace ArcaSolutions\ModStoresBundle\Plugins\HtmlEditorListing;
...
class HtmlEditorListingBundle extends Bundle
{
    ...
    public function boot()
    {
        ...
        try {
            ...
            if ($this->isSitemgr()) {
                 ...
                 */
                Hooks::Register('listingform_overwrite_longdescription', function (&$params = null) {
                    return $this->getListingFormOverwriteLongDescription($params,false);
                });
                 ...
                 */
                Hooks::Register('listingform_overwrite_longdescription', function (&$params = null) {
                    return $this->getListingFormOverwriteLongDescription($params, true);
                });
                Hooks::Register('detaileditor-about_overwrite_longdescription', function (&$params = null) {
                    return $this->getListingDetailOverwriteLongDescription($params);
                });
            ...
            if (!empty($logger)) {
                $logger->critical('Unexpected error on boot method of HtmlEditorListingBundle.php', ['exception' => $e]);
            } else {
    ...
    private function getListingFormOverwriteLongDescription(&$params = null, $isSponsorPage = false)
    {
            ...
            try {
                ...
                if (!empty($twig)) {
                    try {
                        ...
                        echo $twig->render('HtmlEditorListingBundle::legacy-sitemgr-form-listing-html-editor-listing-overwrite-long-description.html.twig', ['id'=>'long_description', 'name'=>'long_description', 'rows'=>30, 'cols'=>15, 'content'=>$content, 'lang'=>$lang]);
                    } catch (Twig_Error_Loader $e) {
                        if ($this->devEnvironment) {
                            echo '<div class="form-group row custom-content-row">Error on template load.<div class="col-sm-6"></div></div>';
                        } else {
                            if (!empty($logger)) {
                                $logger->error("Load error on template 'legacy-sitemgr-form-listing-html-editor-listing-overwrite-long-description.html.twig'.", ['exception' => $e]);
                            }
                        }
                        ...
                        if ($this->devEnvironment) {
                            ...
                            if (!empty($logger)) {
                                $logger->error("Runtime error on template 'legacy-sitemgr-form-listing-html-editor-listing-overwrite-long-description.html.twig'.", ['exception' => $e]);
                            }
                        }
                        ...
                        if ($this->devEnvironment) {
                            ...
                            if (!empty($logger)) {
                                $logger->error("Syntax error on template 'legacy-sitemgr-form-listing-html-editor-listing-overwrite-long-description.html.twig'.", ['exception' => $e]);
                            }
                        }
                    }
                }
                ...
                if (!empty($logger)) {
                    $logger->critical('Unexpected error on getListingFormOverwriteLongDescription method of HtmlEditorListingBundle.php', ['exception' => $e]);
                } else {
                    $notLoggedCriticalException = $e;
                }
            } finally {
    ...
    private function getListingDetailOverwriteLongDescription(&$params = null)
    {
        $paramsReturn = true;
        if (!empty($params) && !empty($this->container)) {
            $logger = $this->container->get('logger');
