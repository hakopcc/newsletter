...
namespace ArcaSolutions\ModStoresBundle\Plugins\GeoTargetedBanner\Command;
...
class EdirectoryModstoresInstallCommand extends AbstractEdirectoryModstoresInstallCommand
{
    ...
    public function afterCommandWorkflow()
    {
        ...
        $this->appendToData('afterCommand', [
            'fixture:domain' => [
                'fixtures' => [
                    'src/ArcaSolutions/ModStoresBundle/Plugins/GeoTargetedBanner/DataFixtures/ORM/Common',
                ],
            ],
        ]);
    }
