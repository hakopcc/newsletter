...
namespace ArcaSolutions\ModStoresBundle\Plugins\AdditionalVideosArticle\Command;
...
class EdirectoryModstoresInstallCommand extends AbstractEdirectoryModstoresInstallCommand
{
    ...
    {
        $this->getIo()->writeln('[-] Copy migrates files');
    ...
    public function afterCommandWorkflow()
    {
        ...
        $this->appendToData('afterCommand', [
            'fixture:domain' => [
                'fixtures' => [
                    'src/ArcaSolutions/ModStoresBundle/Plugins/AdditionalVideosArticle/DataFixtures/ORM/Common',
                ],
            ],
        ]);
    }
