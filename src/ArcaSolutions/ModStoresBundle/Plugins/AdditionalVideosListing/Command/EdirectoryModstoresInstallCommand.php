...
namespace ArcaSolutions\ModStoresBundle\Plugins\AdditionalVideosListing\Command;
...
class EdirectoryModstoresInstallCommand extends AbstractEdirectoryModstoresInstallCommand
{
    ...
    public function afterCommandWorkflow()
    {
        ...
        $this->appendToData('afterCommand', [
            'fixture:domain' => [
                'fixtures' => [
                    'src/ArcaSolutions/ModStoresBundle/Plugins/AdditionalVideosListing/DataFixtures/ORM/Common',
                ],
            ],
        ]);
    }
