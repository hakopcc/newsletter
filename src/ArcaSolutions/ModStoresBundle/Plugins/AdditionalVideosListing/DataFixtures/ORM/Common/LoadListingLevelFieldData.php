...
namespace ArcaSolutions\ModStoresBundle\Plugins\AdditionalVideosListing\DataFixtures\ORM\Common;
...
class LoadListingLevelFieldData extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        foreach ($standardInserts as $listingLevelFieldInsert) {
            ...
            if (!$manager->getRepository('AdditionalVideosListingBundle:ListingLevelFieldVideos')->findOneBy([
                'level' => $listingLevelFieldInsert['level'],
            ])) {

                $listingLevelField = new ListingLevelFieldVideos();
