...
/**
 * Class CsvDataExtractorAndPersistTest
 *
 * @author Diego Mosela <diego.mosela@arcasolutions.com>
 * @package ArcaSolutions\ImportBundle\Test
 * @since 11.3.00
 */
class CsvDataExtractorAndPersistTest extends WebTestCase
{
    //@formatter:off
    const HEADERS = [
    ...
    const MAPPING = [
        ...
        21 => "listingShortDescription",    22 => "listingLongDescription",     23 => "listingSeoDescription",  24 => "listingKeywords",
        25 => "listingRenewalDate",         26 => "listingStatus",              27 => "listingLevel",           28 => "listingCategory1",
        29 => "listingCategory2",           30 => "listingCategory3",           31 => "listingCategory4",       32 => "listingCategory5",
        33 => "listingListingTemplateName", 34 => "listingId",                  35 => "listingThirdPartyId",    36 => "accountUsername",
        37 => "accountPassword",            38 => "accountFirstName",           39 => "accountLastName",        40 => "accountCompany",
        41 => "accountAddress",             42 => "accountAddress2",            43 => "accountCountry",         44 => "accountState",
        45 => "accountCity",                46 => "accountZipCode",             47 => "accountPhone",           49 => "accountEmail",
        50 => "accountUrl",
    ];
    //@formatter:on
    /**
     ...
     *
     */
    public function testShouldListingExtractHeadersCsv()
    {
        // Given
        $file = new \SplFileObject(__DIR__."/Fixtures/edirectory_sample_medium.csv");
        $analyzer = new CsvAnalyzer($file, ';');
     ...
     * @since 11.3.00
     */
    public function testShouldListingExtractorRowsCsv()
    {
        // Given
        $file = new \SplFileObject(__DIR__."/Fixtures/edirectory_sample_medium.csv");
        $this->extractor->fromCsvFile($file, true, ";")
     ...
     * @since 11.3.00
     */
    public function testShouldListingExtractorRowsCsvAndPersistInElastic()
    {
        ///////
        /// Extract rows
