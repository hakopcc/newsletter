<?php
	...
	$url_redirect = ''.DEFAULT_URL.'/'.MEMBERS_ALIAS.'/'.LISTING_FEATURE_FOLDER.'/listing.php';
...
?>
    ...
    <div class="members-page">
        <div class="container">
            <div class="members-wrapper">
                <?php if ($id) { ?>
                    <?php include(MEMBERS_EDIRECTORY_ROOT."/".LISTING_FEATURE_FOLDER."/navbar.php"); ?>
                <?php } ?>
    ...
    <?php
    /* ModStores Hooks */
    HookFire("legacy-sponsors-listing_before_modal-includes", []);

    include INCLUDES_DIR.'/modals/modal-upgrade.php';
