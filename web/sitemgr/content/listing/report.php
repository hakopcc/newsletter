<?php
    ...
    */
    ...
    mixpanel_track("Accessed Manage Listings reports section");
            ...
            <div class="main-content" content-full="true">
                ...
                <section class="section-heading">
                    <div class="section-heading-content">
                        ...
                        <h1 class="section-heading-title"><?=string_ucwords(system_showText(LANG_SITEMGR_REPORT_TRAFFICREPORT))?> - <?=$listing->getString("title")?></h1>
                    </div>
                </section>
                                ...
                                <div class="col-md-12 form-horizontal">
                                    <div class="table-responsive">
                                        <?php if (count($reports) > 0) { ?>
                                            <?php include(INCLUDES_DIR."/tables/table_listing_reports.php"); ?>
                                        <?php } else { ?>
