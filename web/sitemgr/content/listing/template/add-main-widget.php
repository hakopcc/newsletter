<?php
    ...
    */
    ...
    # ----------------------------------------------------------------------------------------------------
    # * FILE: /sitemgr/content/listing/template/add-main-widget.php
    # ----------------------------------------------------------------------------------------------------
    ...
    $mainWidgets = $listingWidgetService->getListingWidgetsByTypeAndSection('detail', 'main');
?>
            ...
            <div class="widget-list">
                <?php
                    foreach ($mainWidgets as $widget) {
                        ...
                        $imgPath = '../../../assets/img/listing-widget-placeholder/main/'.system_generateFriendlyURL($widget['title']).'.jpg';

                        if (!file_exists(EDIRECTORY_ROOT.'/'.SITEMGR_ALIAS.'/assets/img/listing-widget-placeholder/main/'.system_generateFriendlyURL($widget['title']).'.jpg')) {
                            $imgPath = '../../../assets/img/listing-widget-placeholder/main/custom-content.jpg';
                        }
                ?>
