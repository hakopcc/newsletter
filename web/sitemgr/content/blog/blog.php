<?php
    ...
    */
    ...
    $url_redirect = "".DEFAULT_URL."/".SITEMGR_ALIAS."/content/".BLOG_FEATURE_FOLDER.'/blog.php';
    ...
    mixpanel_track(($id ? "Edited an existing post" : "Added a new post"));
        ...
        <div class="main-wrapper">
            ...
            <div class="main-content" content-full="true">
                ...
                <?php } else { ?>
                    ...
                    <form role="form" name="blog" id="blog" class="form-content-blocked" action="<?= system_getFormAction($_SERVER["PHP_SELF"]) ?>" method="post" enctype="multipart/form-data">
                        ...
                        <section class="section-heading">
                            <div class="section-heading-content">
                                <a href="<?=DEFAULT_URL."/".SITEMGR_ALIAS."/content/".BLOG_FEATURE_FOLDER."/index.php?".($url_search_params ? "&$url_search_params" : '')?>" class="heading-back-button"><i class="fa fa-angle-left"></i> <?=system_showText(LANG_SITEMGR_BLOG_SING);?></a>
                                <?php if ($id) { ?>
                                    <h1 class="section-heading-title"><?= string_ucwords(system_showText(LANG_SITEMGR_EDIT));?> <?= $post->getString("title") ?></h1>
                                <?php } else { ?>
                                    <h1 class="section-heading-title"><?= string_ucwords(system_showText(LANG_SITEMGR_ADD))." ".system_showText(LANG_BLOG); ?></h1>
                                <?php } ?>
                            </div>
                        ...
                        <section class="row footer-action">
                            <div class="container">
                                <div class="col-xs-12 text-right">
                                    <a href="<?= DEFAULT_URL."/".SITEMGR_ALIAS."/content/".BLOG_FEATURE_FOLDER."/" ?>"
