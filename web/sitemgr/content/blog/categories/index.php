<?php
    ...
    */
    ...
    mixpanel_track('Accessed Manage Blog Categories section');
	...
	$pageObj  = new pageBrowsing('BlogCategory', $screen, RESULTS_PER_PAGE, 'title, id', 'title', $letter, $isNullSegment . 'category_id = ' .db_formatNumber($category_id), 'id, `title`, enabled');
...
?>
    ...
    <main class="main-dashboard" id="view-content-list">
        ...
        <input type="hidden" id="module" value="blog">
    </main>
