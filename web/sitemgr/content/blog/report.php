            ...
            <div class="main-content" content-full="true">
                ...
                <section class="section-heading">
                    <div class="section-heading-content">
                        <a href="<?=DEFAULT_URL."/".SITEMGR_ALIAS."/content/".BLOG_FEATURE_FOLDER."/"?>" class="heading-back-button"><i class="fa fa-angle-left"></i> <?=system_showText(LANG_SITEMGR_BLOG_SING);?></a>
                        <h1 class="section-heading-title"><?=string_ucwords(system_showText(LANG_SITEMGR_REPORT_TRAFFICREPORT))?> - <?=$post->getString("title")?></h1>
                    </div>
                </section>
                                ...
                                <div class="col-md-12 form-horizontal">
                                    <div class="table-responsive">
                                        <?php if (count($reports) > 0) { ?>
                                            <?php include(INCLUDES_DIR."/tables/table_blog_reports.php"); ?>
                                        <?php } else { ?>
