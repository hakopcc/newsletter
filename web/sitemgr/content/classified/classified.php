<?php
    ...
    */
    ...
    $url_redirect = "".DEFAULT_URL."/".SITEMGR_ALIAS."/content/".CLASSIFIED_FEATURE_FOLDER.'/classified.php';
        ...
        <div class="main-wrapper">
            ...
            <div class="main-content" content-full="true">
                ...
                <?php } else { ?>
                    ...
                    <form role="form" name="classified" id="classified" class="form-content-blocked" action="<?= system_getFormAction($_SERVER["PHP_SELF"]) ?>" method="post" enctype="multipart/form-data">
                        ...
                        <section class="section-heading">
                            <div class="section-heading-content">
                                <a href="<?=DEFAULT_URL."/".SITEMGR_ALIAS."/content/".CLASSIFIED_FEATURE_FOLDER."/index.php?".($url_search_params ? "&$url_search_params" : '')?>" class="heading-back-button"><i class="fa fa-angle-left"></i> <?=system_showText(LANG_SITEMGR_NAVBAR_CLASSIFIED);?></a>
                                <?php if ($id) { ?>
                                    <h1 class="section-heading-title"><?= string_ucwords(system_showText(LANG_SITEMGR_EDIT));?> <?= $classified->getString("title") ?></h1>
                                <?php } else { ?>
                                    <h1 class="section-heading-title"><?= string_ucwords(system_showText(LANG_SITEMGR_ADD))." ".system_showText(LANG_SITEMGR_CLASSIFIED_SING) ?></h1>
                                <?php } ?>
                            </div>
                        ...
                        <section class="row tab-options new-structure-form-block">
                            <div class="tab-content">
                                <div class="tab-pane active">
                                    <div class="container">
                                        <?php include(INCLUDES_DIR."/forms/form-classified.php"); ?>
                                    </div>
                                </div>
                            </div>
                        </section>
