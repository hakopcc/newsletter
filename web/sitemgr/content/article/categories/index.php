<?php
    ...
    */
    ...
    mixpanel_track('Accessed Manage Articles Categories section');
	...
	$pageObj  = new pageBrowsing('ArticleCategory', $screen, RESULTS_PER_PAGE, 'title, id', 'title', $letter, $isNullSegment . 'category_id = ' .db_formatNumber($category_id), 'id, `title`, enabled');
...
?>
    ...
    <main class="main-dashboard" id="view-content-list">
        ...
        <input type="hidden" id="module" value="article">
    </main>
