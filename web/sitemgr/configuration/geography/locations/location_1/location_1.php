<?php
    ...
    */
	...
	define("LOCATION_TITLE", string_ucwords(system_showText(constant("LANG_LABEL_".LOCATION1_SYSTEM))));
                ...
                <form role="form" action="<?=system_getFormAction($_SERVER["PHP_SELF"])?>" name="location_data_in" id="location_data_in" method="post">
                    ...
                    <section class="section-heading">
                        <div class="section-heading-content">
                            <a href="<?=$url_base."/locations/location_1/index.php?".($_location_node_params?$_location_node_params : "")?>" class="heading-back-button"><i class="fa fa-angle-left"></i> <?=system_showText(LANG_SITEMGR_GEO_LOCATIONDATA);?></a>
                            <?php if ($id) { ?>
