    ...
    <div class="modal-content">
        <div class="modal-header">
            <div class="modal-header-content">
                <h4 class="modal-title" id="myModalLabel"><?=system_showText(LANG_SITEMGR_WIDGET_LABEL_LINKED_LISTING)?></h4>
            </div>
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary btn-lg" onclick="saveListingWidget('linkedlistings', true)"><?=system_showText(LANG_SITEMGR_SAVE)?></button>
        </div>
    </div>
</div>
