    ...
    <div class="modal-content">
        <div class="modal-header">
            <div class="modal-header-content">
                <h4 class="modal-title" id="myModalLabel"><?=system_showText(LANG_SITEMGR_WIDGET_SPECIALTIES)?></h4>
            </div>
            <div class="modal-header-action">
                <div class="toggle-required-widget">
                    <?=system_showText(LANG_SITEMGR_LISTINGTEMPLATE_REQUIRED)?>
                    <div class="switch-button <?=$content['required'] === 'disabled' ? 'is-disable' : 'is-enable'?>" onclick="toggleItem(this, 'specialtiesRequired')">
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary btn-lg buttonSave" onclick="saveListingWidget('specialties')"><?=system_showText(LANG_SITEMGR_SAVE)?></button>
        </div>
    </div>
</div>
