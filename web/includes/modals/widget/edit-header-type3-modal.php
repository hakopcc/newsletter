...
<div class="modal-dialog modal-lg widget-header" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <?php
            /* ModStores Hooks */
            if (!HookFire('legacy-includes-modals-widget-editheadertype3_overwrite_navigation-edit', array('aux_LI_code'=>&$aux_LI_code, 'navigation_area'=>&$navigation_area , 'selected_domain_id'=>SELECTED_DOMAIN_ID ))) { ?>
            <div class="row">
                <div class="col-sm-12">
            ...
            <div class="row">
                <div class="col-xs-12 text-right">
                    ...
                    <button type="button" class="btn btn-primary btn-lg action-save"
                            ...
                            onclick="<?= DEMO_LIVE_MODE ? 'livemodeMessage(true, false);' : "saveWidget('header-with-phone');" ?>"><?= system_showText(LANG_SITEMGR_SAVE_CHANGES); ?></button>
                </div>
            </div>
