...
LANG_JS_MINS = 'Min';
//Label Next Day
LANG_NEXT_DAY = 'Il giorno dopo';
//Feature Icon or Name can't be empty.
LANG_FEATURE_NAME_EMPTY = 'L\'icona o il nome della caratteristica non possono essere vuoti.';
//Add a Widget
LANG_ADD_WIDGET = 'Aggiungere un widget';
//New Tab
LANG_NEW_TAB = 'Nuova Scheda';
//All
LANG_ALL = 'Tutti';
//Could not load video. Please check your video URL and try again.
LANG_COULD_NOT_LOAD_VIDEO = 'Impossibile caricare il video. Controlla l\'URL del tuo video e riprova.';
//Video uploaded successfully
LANG_VIDEO_UPLOADED_SUCCESSFULLY = 'Video caricato correttamente';
//'Please select a default listing template in case your imported file doesn\'t include this data.'
LANG_SELECT_DEFAULT_LISTING_TEMPLATE = 'Seleziona un modello di elenco predefinito nel caso in cui il file importato non includa questi dati.';
//You can display up to 10 items on this widget
LANG_DISPLAY_MAX_ITEM = 'È possibile visualizzare fino a 10 elementi su questo widget';
