...
//Add a Widget
LANG_ADD_WIDGET = 'Add a Widget';
//New Tab
LANG_NEW_TAB = 'New Tab';
//All
LANG_ALL = 'All';
//Could not load video. Please check your video URL and try again.
LANG_COULD_NOT_LOAD_VIDEO = 'Could not load video. Please check your video URL and try again.';
//Video uploaded successfully
LANG_VIDEO_UPLOADED_SUCCESSFULLY = 'Video uploaded successfully';
//'Please select a default listing template in case your imported file doesn\'t include this data.'
LANG_SELECT_DEFAULT_LISTING_TEMPLATE = 'Please select a default listing template in case your imported file doesn\'t include this data.';
//You can display up to 10 items on this widget
LANG_DISPLAY_MAX_ITEM = 'You can display up to 10 items on this widget';
