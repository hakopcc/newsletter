<?php
    ...
    ?>
    <header class="header" data-type="2" is-sticky="<?=$widgetContent['stickyMenu'] === 'true' ? 'true' : 'false' ?>" is-inverse="<?=$widgetContent['backgroundColor'] === 'base' ? 'true' : 'false'?>" has-opacity="<?=$widgetContent['isTransparent'] === 'true' ? 'true' : 'false' ?>" has-mod="<?HookFire("header_check_dropdown")?>" has-search="true">
            ...
            <div class="container">
                <div class="wrapper">
                    <div class="content-left">
                        ...
                        <a href="<?=DEFAULT_URL.'/'.ALIAS_ADVERTISE_URL_DIVISOR?>" id="navbar-listwithus" class="navbar-link"><?=$translator->trans($widgetContent['labelListWithUs'], [], 'widgets')?></a>
                        ...
                        <?php } else { ?>
                            <a href="javascript:void(0);" data-modal="login" id="navbar-signin" class="navbar-link"><?=$translator->trans($widgetContent['labelSignIn'], [], 'widgets')?></a>
                        <?php } ?>
